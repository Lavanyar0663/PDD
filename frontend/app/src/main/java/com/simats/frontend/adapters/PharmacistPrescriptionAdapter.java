...
public class PharmacistPrescriptionAdapter extends RecyclerView.Adapter<PharmacistPrescriptionAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Hide dispense action if not PENDING
        ...
        holder.btnDispense.setOnClickListener(v -> {
            if ("PENDING".equalsIgnoreCase(prescription.getStatus())) {
                dispensePrescription(prescription.getId(), position);
            }
        });
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            // Reusing chevron icon click as a 'dispense' action for simplicity given UI.

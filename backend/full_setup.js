...
async function setup() {
    ...
    const seedUsers = [
        ...
        // Doctors (5)
        { name: 'Dr. Arjun Raman', email: 'arjun@diasrx.com', role: 'doctor', spec: 'General Dentistry' },
        { name: 'Dr. Sarah Jenkins', email: 'sarah@diasrx.com', role: 'doctor', spec: 'Orthodontics' },
        { name: 'Dr. Michael Chen', email: 'michael@diasrx.com', role: 'doctor', spec: 'Periodontics' },
        { name: 'Dr. Alana Smith', email: 'alana@diasrx.com', role: 'doctor', spec: 'Endodontics' },
        { name: 'Dr. Robert Wilson', email: 'robert@diasrx.com', role: 'doctor', spec: 'Oral Surgery' },
        // Pharmacists (3)
        ...
        // Patients (15)
        { name: 'Meena Krishnan', email: 'meena@diasrx.com', role: 'patient', age: 34, gender: 'Female' },
        { name: 'Michael Ross', email: 'michael.r@diasrx.com', role: 'patient', age: 45, gender: 'Male' },
        { name: 'David Miller', email: 'david@diasrx.com', role: 'patient', age: 28, gender: 'Male' },
        { name: 'Emma Watson', email: 'emma@diasrx.com', role: 'patient', age: 22, gender: 'Female' },
        { name: 'Robert Chen', email: 'robert.c@diasrx.com', role: 'patient', age: 51, gender: 'Male' },
        { name: 'Sophia Lee', email: 'sophia@diasrx.com', role: 'patient', age: 30, gender: 'Female' },
        { name: 'James Taylor', email: 'james@diasrx.com', role: 'patient', age: 60, gender: 'Male' },
        { name: 'Olivia Brown', email: 'olivia@diasrx.com', role: 'patient', age: 25, gender: 'Female' },
        { name: 'William Davis', email: 'william@diasrx.com', role: 'patient', age: 40, gender: 'Male' },
        { name: 'Mia Wilson', email: 'mia@diasrx.com', role: 'patient', age: 33, gender: 'Female' },
        { name: 'Benjamin Moore', email: 'benjamin@diasrx.com', role: 'patient', age: 55, gender: 'Male' },
        { name: 'Isabella Clark', email: 'isabella@diasrx.com', role: 'patient', age: 27, gender: 'Female' },
        { name: 'Lucas Lewis', email: 'lucas@diasrx.com', role: 'patient', age: 38, gender: 'Male' },
        { name: 'Amelia Walker', email: 'amelia@diasrx.com', role: 'patient', age: 42, gender: 'Female' },
        { name: 'Henry Hall', email: 'henry@diasrx.com', role: 'patient', age: 65, gender: 'Male' }
    ];
    ...
    for (const u of seedUsers) {
        ...
        if (rows && rows.length > 0) {
            ...
            if (u.role === 'admin') {
                ...
                await query(`INSERT IGNORE INTO doctors (name, email, password, specialization, user_id) VALUES ('${u.name}', '${u.email}', '${hash}', '${u.spec || ''}', ${userId})`);
                ...
                await query(`INSERT IGNORE INTO patients (name, email, age, gender) VALUES ('${u.name}', '${u.email}', ${u.age || 30}, '${u.gender || 'Unknown'}')`);
            }
        }
    }
